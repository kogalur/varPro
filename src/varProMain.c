...
#pragma omp parallel for num_threads(RF_numThreads)
  ...
  VP_treeID_ = (uint*) stackAndProtect(RF_auxDimConsts,
                                       ...
                                       VP_totalRecordCount,
                                       0,
                                       RF_sexpStringOutgoing[VP_TREE_ID],
                                       NULL,
                                       1,
                                       VP_totalRecordCount);
  VP_treeID_ --;
  VP_nodeID_ = (uint*) stackAndProtect(RF_auxDimConsts,
                                       ...
                                       VP_totalRecordCount,
                                       0,
                                       RF_sexpStringOutgoing[VP_NODE_ID],
                                       NULL,
                                       1,
                                       VP_totalRecordCount);
  VP_nodeID_ --;
  VP_xReleaseID_ = (uint*) stackAndProtect(RF_auxDimConsts,
                                           ...
                                           VP_totalRecordCount,
                                           0,
                                           RF_sexpStringOutgoing[VP_XVAR_ID],
                                           NULL,
                                           1,
                                           VP_totalRecordCount);
  VP_xReleaseID_ --;
  ...
  if (RF_rNonFactorCount > 0) {
    ...
    if (!(VP_opt & (VP_OPT_CMP | VP_OPT_OOB))) {
      VP_importance_ = (double*) stackAndProtect(RF_auxDimConsts,
                                                 ...
                                                 localSize,
                                                 0,
                                                 RF_sexpStringOutgoing[VP_STAT_IMP],
                                                 & VP_dimImpRGRptr,
                                                 2,
                                                 RF_rNonFactorCount,
                                                 VP_totalRecordCount);
      ...
      VP_complementStat_ = (double*) stackAndProtect(RF_auxDimConsts,
                                                     ...
                                                     localSize,
                                                     0,
                                                     RF_sexpStringOutgoing[VP_STAT_COMPL],
                                                     & VP_dimImpRGRptr,
                                                     2,
                                                     RF_rNonFactorCount,
                                                     VP_totalRecordCount);
      ...
      VP_oobStat_ = (double*) stackAndProtect(RF_auxDimConsts,
                                              ...
                                              localSize,
                                              0,
                                              RF_sexpStringOutgoing[VP_STAT_OOB],
                                              & VP_dimImpRGRptr,
                                              2,
                                              RF_rNonFactorCount,
                                              VP_totalRecordCount);
