...
struct quantileObj {
  ...
  uint g;
  uint dlt;
  struct quantileObj *fwdLink;
  struct quantileObj *bakLink;
};
typedef struct lookUpInfo LookUpInfo;
struct lookUpInfo {
  struct quantileObj *qPtr;
  struct lookUpInfo *rootPtr;
  struct lookUpInfo *leftPtr;
  struct lookUpInfo *rghtPtr;
};
